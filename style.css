...
/* === STYLE UNTUK CUSTOM VALIDASI FORM KRITIK & SARAN (Tooltip) === */

/* Wrapper untuk positioning relatif */
.feedback-input-wrapper {
    position: relative;
    /* Tambahkan margin-bottom jika perlu untuk menjaga jarak antar form element */
    margin-bottom: 20px; /* Sesuaikan sesuai kebutuhan layout Anda */
}

/* Style untuk textarea saat inputnya kosong (error) */
textarea.textarea-error {
  border-color: #D93025 !important; /* Border merah, gunakan !important jika ada style lain yang menimpa */
  box-shadow: 0 0 0 1px #D93025; /* Shadow merah tipis */
}

/* (Opsional) Beri efek glow merah saat textarea error difokuskan */
textarea.textarea-error:focus {
    box-shadow: 0 0 0 4px rgba(217, 48, 37, 0.2), 0 0 0 1px #D93025 !important;
}

/* Style untuk tooltip pesan error */
.custom-error-tooltip {
    position: absolute;
    bottom: -45px; /* Sesuaikan posisi vertikal di bawah textarea */
    left: 0;
    background-color: #F8D7DA; /* Warna background error, sesuaikan jika ingin oranye */
    ...
    display: flex;
    align-items: center;
    z-index: 10; /* Pastikan tooltip muncul di atas elemen lain */

    /* Arrow (panah) pada tooltip */
    &::before {
        content: '';
        position: absolute;
        top: -8px; /* Posisi panah di atas tooltip */
        left: 15px; /* Sesuaikan posisi horizontal panah */
        border-width: 0 8px 8px 8px;
        border-style: solid;
        border-color: transparent transparent #F8D7DA transparent; /* Warna panah mengikuti background tooltip */
    }
...
/* Style untuk ikon di dalam tooltip */
.custom-error-tooltip .fas {
    margin-right: 8px;
    color: #DC3545; /* Warna ikon, bisa disesuaikan */
}

/* Tampilkan tooltip saat aktif */
.custom-error-tooltip.active {
    opacity: 1;
    visibility: visible;
}

/* Jika ingin warna oranye seperti contoh */
/*
.custom-error-tooltip {
