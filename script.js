        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const feedbackErrorTooltip = document.getElementById('feedbackError'); 
            const feedbackErrorText = feedbackErrorTooltip ? feedbackErrorTooltip.querySelector('span') : null; 

            if (submitButton && feedbackMessage && feedbackErrorTooltip && feedbackErrorText) {
                submitButton.addEventListener('click', function(event) {
                    event.preventDefault(); 
                    const whatsAppNumber = '6282141055207';
                    const message = feedbackMessage.value.trim(); 
                    if (message === '') {
                        feedbackErrorTooltip.classList.add('active'); 
                        feedbackMessage.classList.add('textarea-error'); 
                    } else {
                        feedbackErrorTooltip.classList.remove('active'); 
                        feedbackMessage.classList.remove('textarea-error'); 
                ...
                // (Bonus UX) Sembunyikan pesan error saat pengguna mulai mengetik
